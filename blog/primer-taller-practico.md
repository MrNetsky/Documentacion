...
<div style={{ textAlign: 'center', marginBottom: '40px' }}>
  <img
    src={useBaseUrl("/img/1er_taller.jpeg")}
    alt="Foto con los asistentes"
    style={{
      maxWidth: '100%',
      height: 'auto',
      display: 'block',
  ...
  />
  <p>**Participantes de la primera jornada de capacitación práctica de Meshtastic, realizada junto a brigadas de combatientes del fuego en San Isidro, Santa María, Córdoba.**</p>
</div>
